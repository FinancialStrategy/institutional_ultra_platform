...
def tab_stress_testing(prices: pd.DataFrame):
    ...
    chosen = st.multiselect("Select historical stress events", list(StressTestEngine.HISTORICAL.keys()),
                            default=["Dot-com Bubble Burst (2000-2002)", "9/11 Shock (2001)"] if "9/11 Shock (2001)" in StressTestEngine.HISTORICAL else list(StressTestEngine.HISTORICAL.keys())[:2], key="stress_hist_events")
